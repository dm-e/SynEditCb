...
private:
	...
	System::Classes::TStrings* FProcNames;
	...
	void __fastcall SetProcNames(System::Classes::TStrings* const Value);
protected:
	virtual String __fastcall GetSampleSource();
	virtual bool __fastcall IsFilterStored();
public:
	typedef Synedithighlighter::TSynCustomHighlighter inherited;	
	#include "SynHighlighterSQL_friends.inc"
	__classmethod virtual String __fastcall GetLanguageName();
	__classmethod virtual String __fastcall GetFriendlyLanguageName();
	__fastcall TSynSQLSyn(System::Classes::TComponent* AOwner);
...
__published:
	...
	__property TSynHighlighterAttributes* ConditionalCommentAttri = { read = fConditionalCommentAttri, write = fConditionalCommentAttri };
	__property TSynHighlighterAttributes* ConsoleOutputAttri = { read = fConsoleOutputAttri, write = fConsoleOutputAttri };
	__property TSynHighlighterAttributes* DataTypeAttri = { read = fDataTypeAttri, write = fDataTypeAttri };
	__property TSynHighlighterAttributes* DefaultPackageAttri = { read = fDefaultPackageAttri, write = fDefaultPackageAttri };
	__property TSynHighlighterAttributes* DelimitedIdentifierAttri = { read = fDelimitedIdentifierAttri, write = fDelimitedIdentifierAttri };
	__property TSynHighlighterAttributes* ExceptionAttri = { read = fExceptionAttri, write = fExceptionAttri };
	...
	__property TSynHighlighterAttributes* PLSQLAttri = { read = fPLSQLAttri, write = fPLSQLAttri };
	__property TSynHighlighterAttributes* SpaceAttri = { read = fSpaceAttri, write = fSpaceAttri };
	__property TSynHighlighterAttributes* SQLPlusAttri = { read = fSQLPlusAttri, write = fSQLPlusAttri };
	...
	__property TSynHighlighterAttributes* ProcNameAttri = { read = fProcNameAttri, write = fProcNameAttri };
	__property TSynHighlighterAttributes* TableNameAttri = { read = fTableNameAttri, write = fTableNameAttri };
