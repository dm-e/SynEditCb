...
public:
	...
	__fastcall TSynEditFontProperty(Designintf::IDesigner* const ADesigner, int APropCount);
...
public:
	...
	__fastcall TSynEditCommandProperty(Designintf::IDesigner* const ADesigner, int APropCount);
...
public:
	...
	virtual void __fastcall Edit();
	virtual Designintf::TPropertyAttributes __fastcall GetAttributes();
	__fastcall TSynEditKeystrokesProperty(Designintf::IDesigner* const ADesigner, int APropCount);
...
public:
	...
	virtual void __fastcall Edit();
	virtual Designintf::TPropertyAttributes __fastcall GetAttributes();
	__fastcall TSynEditPrintMarginsProperty(Designintf::IDesigner* const ADesigner, int APropCount);
...
public:
	...
	virtual Designintf::TPropertyAttributes __fastcall GetAttributes();
	virtual String __fastcall GetValue();
	__fastcall TAutoCorrectionProperty(Designintf::IDesigner* const ADesigner, int APropCount);
...
public:
	...
	__fastcall TSynAutoCorrectComponentEditor(System::Classes::TComponent* AComponent, Designintf::IDesigner* ADesigner);
