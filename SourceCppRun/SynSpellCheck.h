...
typedef void __fastcall (__closure *TOnCheckWord) (TObject*, String, TStringList*, String&, int&, bool/*# = true*/);
...
enum SynSpellCheckOptions {sscoAutoSpellCheck,
                           ...
                           sscoSuggestWords,
                           sscoTrimApostrophes };
typedef System::Set<SynSpellCheckOptions, SynSpellCheckOptions::sscoAutoSpellCheck, SynSpellCheckOptions::sscoTrimApostrophes> TSynSpellCheckOptions;
...
//    FIdentChars: set of Char;
	...
	void __fastcall SetSkipList(TStringList* Value);  //*
	void __fastcall SortWordList();
	void __fastcall SetCheckAttribs(TStringList* const Value);
...
/*begin moved from private*/                                                      //Fiala
	...
	int __fastcall JHCMPFindSimilar(const String Word, int MaxDiffCount, int MaxDiffLength, TStrings* Similar);
...
/*end*/                                                                           //Fiala
	__fastcall TSynSpellCheck(TComponent* AOwner);
	...
	int __fastcall GetSuggestions(String Word, TStringList* SuggestionList);
    ...
    /* Procedures */
	void __fastcall AddDiacritic(TProgressBar* Progress);
	void __fastcall AddDictWord(String Word);
	void __fastcall AddDictWordList(TStringList* WordList);
	void __fastcall AddSkipWord(String Word);
	void __fastcall AddSkipWordList(TStringList* WordList);
	...
	void __fastcall GetDictionaryList(TStringList*& tslList);
