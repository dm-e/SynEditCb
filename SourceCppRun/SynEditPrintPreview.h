...
protected:
	...
	System::Classes::TNotifyEvent FOnScaleChange;                                               // JD 2002-01-9
...
public:
	...
	__fastcall TSynEditPrintPreview(System::Classes::TComponent* AOwner);
...
__published:
	...
	__property TSynEditPrint* SynEditPrint = { read = FSynEditPrint, write = SetSynEditPrint };
