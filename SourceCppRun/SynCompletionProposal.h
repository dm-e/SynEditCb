...
typedef void __fastcall (__closure *TSynBaseCompletionProposalPaintItem) (TObject*, int, Vcl::Graphics::TCanvas*, const TRect&, bool&);
typedef void __fastcall (__closure *TSynBaseCompletionProposalMeasureItem) (TObject*, int, Vcl::Graphics::TCanvas*, int&);
typedef void __fastcall (__closure *TCodeCompletionEvent) (TObject*, String&, System::Classes::TShiftState, int, WideChar);
typedef void __fastcall (__closure *TAfterCodeCompletionEvent) (TObject*, const String, System::Classes::TShiftState, int, WideChar);
typedef void __fastcall (__closure *TValidateEvent) (TObject*, System::Classes::TShiftState, WideChar);
...
typedef System::Set<TSynCompletionOption, scoCaseSensitive, scoCompleteWithEnter> TSynCompletionOptions;
const System::Set<TSynCompletionOption, scoCaseSensitive, scoCompleteWithEnter> DefaultProposalOptions = System::Set<TSynCompletionOption, scoCaseSensitive, scoCompleteWithEnter>() << Syncompletionproposal::scoLimitToMatchedText << Syncompletionproposal::scoEndCharCompletion << Syncompletionproposal::scoCompleteWithTab << Syncompletionproposal::scoCompleteWithEnter;
...
private:
	...
	Vcl::Graphics::TBitmap* BITMAP; // used for drawing
	Vcl::Graphics::TBitmap* TitleBitmap; // used for title-drawing
...
public:
	__fastcall TSynBaseCompletionProposalForm(System::Classes::TComponent* AOwner);
...
private:
	...
	void __fastcall SetOnKeyPress(const Vcl::Controls::TKeyPressEvent Value);
...
public:
	...
	#include "SynCompletionProposal_friends.inc"
	__fastcall TSynBaseCompletionProposal(System::Classes::TComponent* AOwner);
...
private:
	...
	void __fastcall HandleOnValidate(TObject* Sender, System::Classes::TShiftState Shift, WideChar EndToken);
	void __fastcall HandleOnKeyPress(TObject* Sender, WideChar& key);
	void __fastcall HandleDblClick(TObject* Sender);
	void __fastcall EditorKeyDown(TObject* Sender, WORD& key, System::Classes::TShiftState Shift);
...
public:
	...
	#include "SynCompletionProposal_friends.inc"
	__fastcall TSynCompletionProposal(System::Classes::TComponent* AOwner);
...
private:
	...
	void __fastcall DoInternalAutoCompletion(TObject* Sender, const String Value, System::Classes::TShiftState Shift, int Index, WideChar EndToken);
	bool __fastcall GetExecuting();
protected:
	void __fastcall SetShortCut(System::Classes::TShortCut Value);
	virtual void __fastcall Notification(System::Classes::TComponent* AComponent, System::Classes::TOperation Operation);
	virtual void __fastcall EditorKeyDown(TObject* Sender, WORD& key, System::Classes::TShiftState Shift);
...
public:
	...
	__fastcall TSynAutoComplete(System::Classes::TComponent* AOwner);
...
public:
	...
	#include "SynCompletionProposal_friends.inc"
	__fastcall TProposalColumn(System::Classes::TCollection* Collection);
...
public:
	...
	__fastcall TProposalColumns(System::Classes::TCollectionItemClass ItemClass);
};
void __fastcall FormattedTextOut(Vcl::Graphics::TCanvas* TargetCanvas, const TRect& Rect, int PPI, const String Text, bool Selected, TProposalColumns* Columns, Vcl::Imglist::TCustomImageList* Images);
int __fastcall FormattedTextWidth(Vcl::Graphics::TCanvas* TargetCanvas, const String Text, int PPI, TProposalColumns* Columns, Vcl::Imglist::TCustomImageList* Images);
