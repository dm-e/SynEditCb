...
private:
	...
	HIDESBASE MESSAGE void __fastcall CMEnter(Vcl::Controls::TCMEnter& Msg)/*# CM_ENTER */;
	HIDESBASE MESSAGE void __fastcall CMExit(Vcl::Controls::TCMExit& Msg)/*# CM_EXIT */;
...
public:
	...
	__fastcall TCustomDBSynEdit(System::Classes::TComponent* AOwner);
...
protected:
	...
	BEGIN_MESSAGE_MAP
	  VCL_MESSAGE_HANDLER(CM_ENTER, Vcl::Controls::TCMEnter, CMEnter)
	  VCL_MESSAGE_HANDLER(CM_EXIT, Vcl::Controls::TCMExit, CMExit)
...
public:
	...
	#include "SynDBEdit_friends.inc"
	__fastcall TDBSynEdit(System::Classes::TComponent* AOwner);
