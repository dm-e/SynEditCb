...
public:
	...
	#include "SynHighlighterDml_friends.inc"
	__classmethod virtual String __fastcall GetLanguageName();
	__classmethod virtual String __fastcall GetFriendlyLanguageName();
	__fastcall TSynDmlSyn(System::Classes::TComponent* AOwner);
...
__published:
	__property TSynHighlighterAttributes* BlockAttri = { read = fBlockAttri, write = fBlockAttri };
	__property TSynHighlighterAttributes* CommentAttri = { read = fCommentAttri, write = fCommentAttri };
	__property TSynHighlighterAttributes* FormAttri = { read = fFormAttri, write = fFormAttri };
	...
	__property TSynHighlighterAttributes* QualiAttri = { read = fQualiAttri, write = fQualiAttri };
