...
/* -------------------------------------------------------------------------------
  ...
  Known Issues:
  ------------------------------------------------------------------------------- */
const int MaxIntArraySize = (int)(System::MaxInt / 16);
...
void __fastcall SynDrawGradient(Vcl::Graphics::TCanvas* const ACanvas, const TColor AStartColor, const TColor AEndColor, int ASteps, const TRect& ARect, bool AHorizontal);
