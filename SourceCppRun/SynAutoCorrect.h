...
enum TAsSynAutoCorrectOption {ascoCorrectOnMouseDown,
                              ascoIgnoreCase,
                              ascoMaintainCase };
typedef System::Set<TAsSynAutoCorrectOption, ascoCorrectOnMouseDown, ascoMaintainCase> TAsSynAutoCorrectOptions;
...
protected:
	...
	virtual void __fastcall MouseDownHandler(TObject* Sender, TMouseButton Button, System::Classes::TShiftState Shift, int X, int Y);
...
public:
	...
	__fastcall TCustomSynAutoCorrect(System::Classes::TComponent* AOwner);
...
public:
	...
	#include "SynAutoCorrect_friends.inc"
	__fastcall TSynAutoCorrect(System::Classes::TComponent* AOwner);
};
