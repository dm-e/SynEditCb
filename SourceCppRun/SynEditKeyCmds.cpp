...
__fastcall TSynEditKeyStroke::TSynEditKeyStroke(System::Classes::TCollection* Collection) : inherited(Collection) {}
__fastcall TSynEditKeyStrokes::TSynEditKeyStrokes(System::Classes::TCollectionItemClass ItemClass) : inherited(ItemClass) {}
...
{
	bool result = false;
	result = IdentToInt(Ident, cmd, OpenArrayEx<TIdentMapEntry>(EditorCommandStrs, 113), 112);
	return result;
}
...
{
	bool result = false;
	result = IntToIdent(cmd, Ident, OpenArrayEx<TIdentMapEntry>(EditorCommandStrs, 113), 112);
	return result;
}
...
SynEditKeyCmds_unit _SynEditKeyCmds_unit;
