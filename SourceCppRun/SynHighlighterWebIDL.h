...
public:
	...
	#include "SynHighlighterWebIDL_friends.inc"
	__fastcall TSynWebIDLSyn(System::Classes::TComponent* AOwner);
...
__published:
	__property TSynHighlighterAttributes* ArgumentsAttri = { read = fArgumentsAttri, write = fArgumentsAttri };
	__property TSynHighlighterAttributes* CommentAttri = { read = fCommentAttri, write = fCommentAttri };
	__property TSynHighlighterAttributes* ExtendedAttri = { read = fExtendedAttri, write = fExtendedAttri };
	...
	__property TSynHighlighterAttributes* TypesAttri = { read = fTypesAttri, write = fTypesAttri };
};
