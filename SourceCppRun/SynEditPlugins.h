...
__published:
	__property TCustomSynEdit* Editor = { read = GetEditor, write = SetEditor };
public:
	__fastcall TAbstractSynPlugin(System::Classes::TComponent* AOwner);
};

class TAbstractSynHookerPlugin : public TAbstractSynPlugin
{
protected:
	void __fastcall HookEditor(Synedit::TCustomSynEdit* AEditor, Synedittypes::TSynEditorCommand aCommandID, System::Classes::TShortCut aOldShortCut, System::Classes::TShortCut aNewShortCut);
	void __fastcall UnHookEditor(Synedit::TCustomSynEdit* AEditor, Synedittypes::TSynEditorCommand aCommandID, System::Classes::TShortCut AShortCut);
...
public:
	...
	#include "SynEditPlugins_friends.inc"
	__fastcall TAbstractSynHookerPlugin(System::Classes::TComponent* AOwner);
};
...
public:
	...
	#include "SynEditPlugins_friends.inc"
	__fastcall TAbstractSynSingleHookPlugin(System::Classes::TComponent* AOwner);
...
public:
	...
	__fastcall TAbstractSynCompletion(System::Classes::TComponent* AOwner);
};
