...
public:
	...
	#include "SynHighlighterLLVM_friends.inc"
	__fastcall TSynLLVMIRSyn(System::Classes::TComponent* AOwner);
...
__published:
	__property TSynHighlighterAttributes* BooleanAttribute = { read = fBooleanAttri, write = fBooleanAttri };
	__property TSynHighlighterAttributes* CommentAttribute = { read = fCommentAttri, write = fCommentAttri };
	__property TSynHighlighterAttributes* ConstantAttribute = { read = fConstantAttri, write = fConstantAttri };
	__property TSynHighlighterAttributes* IdentifierAttribute = { read = fIdentifierAttri, write = fIdentifierAttri };
	__property TSynHighlighterAttributes* InstructionAttribute = { read = fInstructionAttri, write = fInstructionAttri };
	__property TSynHighlighterAttributes* KeywordAttribute = { read = fKeyAttri, write = fKeyAttri };
	__property TSynHighlighterAttributes* LabelAttribute = { read = fLabelAttri, write = fLabelAttri };
	__property TSynHighlighterAttributes* NumberAttribute = { read = fNumberAttri, write = fNumberAttri };
	__property TSynHighlighterAttributes* SpaceAttribute = { read = fSpaceAttri, write = fSpaceAttri };
	__property TSynHighlighterAttributes* StringAttribute = { read = fStringAttri, write = fStringAttri };
	__property TSynHighlighterAttributes* TypesAttribute = { read = fTypesAttri, write = fTypesAttri };
};
