...
private:
	...
	bool __fastcall InternalIsKeyword(const String AKeyword, System::Classes::TStrings* KeywordList, bool ACaseSensitive = false);
protected:
	virtual String __fastcall GetSampleSource();
	virtual bool __fastcall IsFilterStored();
public:
	typedef Synedithighlighter::TSynCustomHighlighter inherited;	
	#include "SynHighlighterTclTk_friends.inc"
	__classmethod virtual String __fastcall GetLanguageName();
	__classmethod virtual String __fastcall GetFriendlyLanguageName();
	__fastcall TSynTclTkSyn(System::Classes::TComponent* AOwner);
...
__published:
	...
	__property TSynHighlighterAttributes* TixKeyAttri = { read = fTixKeyAttri, write = fTixKeyAttri };
	__property TStrings* TixWords = { read = fTixWords };
	__property TSynHighlighterAttributes* WidgetKeyAttri = { read = fWidgetKeyAttri, write = fWidgetKeyAttri };
	...
	__property TSynHighlighterAttributes* OptionsAttri = { read = fOptionsAttri, write = fOptionsAttri };
	__property TSynHighlighterAttributes* PathAttri = { read = fPathAttri, write = fPathAttri };
