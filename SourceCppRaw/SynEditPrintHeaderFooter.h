...
public:
	...
	int __fastcall Add(String Text, Vcl::Graphics::TFont* Font, System::Classes::TAlignment Alignment, int LineNumber);
	void __fastcall Delete(int Index);
	void __fastcall Clear();
	int __fastcall Count();
	THeaderFooterItem* __fastcall Get(int Index);
	void __fastcall SetPixPrInch(int Value);
	void __fastcall InitPrint(Vcl::Graphics::TCanvas* ACanvas, int NumPages, String Title, Syneditprintmargins::TSynEditPrintMargins* Margins);
	...
	void __fastcall SaveToStream(System::Classes::TStream* AStream);
__published:
	__property TFrameTypes FrameTypes = { read = FFrameTypes, write = FFrameTypes, default = /*# ftLine */ 0 };
