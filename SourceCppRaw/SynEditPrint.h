...
private:
	...
	void __fastcall TextOut(const String Text, System::Classes::TList* AList);
...
public:
	...
	#include "SynEditPrint_friends.inc"
	__fastcall TSynEditPrint(System::Classes::TComponent* AOwner);
...
__published:
	...
	__property THeader* Header = { read = FHeader, write = SetHeader };
	__property TFooter* Footer = { read = FFooter, write = SetFooter };
	__property TSynEditPrintMargins* Margins = { read = FMargins, write = SetMargins };
	...
	__property TPrintLineEvent OnPrintLine = { read = FOnPrintLine, write = FOnPrintLine };
