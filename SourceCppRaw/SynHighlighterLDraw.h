...
public:
	...
	#include "SynHighlighterLDraw_friends.inc"
	__fastcall TSynLDRSyn(System::Classes::TComponent* AOwner);
...
__published:
	...
	__property TSynHighlighterAttributes* FirstTriAttri = { read = fFirstTriAttri, write = fFirstTriAttri };
	__property TSynHighlighterAttributes* FourthTriAttri = { read = fFourthTriAttri, write = fFourthTriAttri };
	...
	__property TSynHighlighterAttributes* LineAttri = { read = fLineAttri, write = fLineAttri };
	__property TSynHighlighterAttributes* OpLineAttri = { read = fOpLineAttri, write = fOpLineAttri };
	__property TSynHighlighterAttributes* QuadAttri = { read = fQuadAttri, write = fQuadAttri };
	__property TSynHighlighterAttributes* SecondTriAttri = { read = fSecondTriAttri, write = fSecondTriAttri };
	__property TSynHighlighterAttributes* ThirdTriAttri = { read = fThirdTriAttri, write = fThirdTriAttri };
	__property TSynHighlighterAttributes* TriangleAttri = { read = fTriangleAttri, write = fTriangleAttri };
};
