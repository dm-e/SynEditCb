...
public:
	...
	__fastcall TSynDfmSyn(System::Classes::TComponent* AOwner);
...
int __fastcall LoadDFMFile2Strings(const String AFile, System::Classes::TStrings* AStrings, bool& WasText);
int __fastcall SaveStrings2DFMFile(System::Classes::TStrings* AStrings, const String AFile);
