...
class TMDIMainForm : public TMainForm
{
__published:
public:
	TActionList* actlWindow;
	TWindowTileHorizontal* actWindowTileHorz;
	TWindowTileVertical* actWindowTileVert;
	TWindowArrange* actWindowArrange;
	TWindowCascade* actWindowCascade;
	TMenuItem* mWindow;
	TMenuItem* miWindowCascade;
	TMenuItem* miWindowTile;
	TMenuItem* miWindowTileVert;
	TMenuItem* miWindowArrange;
	void __fastcall FormCreate(TObject* Sender);
protected:
	virtual IEditor* __fastcall DoCreateEditor(String AFileName);
public:
	typedef TMainForm inherited;
	__fastcall TMDIMainForm(TComponent* AOwner, int Dummy);
protected:
...
extern PACKAGE TMDIMainForm* MDIMainForm;
