...
Known Issues:
-------------------------------------------------------------------------------*/
#ifndef frmMainWorkbookH
#define frmMainWorkbookH
...
class TWorkbookMainForm : public TMainForm
{
__published:
public:
...
public:
	...
	__fastcall TWorkbookMainForm(TComponent* AOwner, int Dummy);
protected:
...
extern PACKAGE TWorkbookMainForm* WorkbookMainForm;

#endif // frmMainWorkbookH
