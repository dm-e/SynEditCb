...
__published:
	...
	void __fastcall SynEditorReplaceText(TObject* Sender, const String ASearch, const String AReplace, int Line, int Column, TSynReplaceAction& Action);
...
class TEditor : public TInterfacedObject, public IEditor, public IEditCommands, public IFileCommands, public ISearchCommands
{
	#include "frmEditor_friends.inc"
public:
