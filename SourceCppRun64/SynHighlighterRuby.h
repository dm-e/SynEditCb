...
*/
#ifndef SynHighlighterRubyH
#define SynHighlighterRubyH
...
public:
	...
	__fastcall TSynRubySyn(TComponent* AOwner);
	virtual __fastcall ~TSynRubySyn();
...
public:
	...
	__property TStrings* SecondKeyWords = { read = fSecondKeys, write = SetSecondKeys };
