...
TIdTokenKind TGenLex::IdentKind(PWideChar Maybe)
{
	TIdTokenKind result = TIdTokenKind::IdBeginFunc;
	int HashKey = 0;
	fToIdent = Maybe;
...
TIdTokenKind TGenLex::BraceOpenFunc()
{
	TIdTokenKind result = TIdTokenKind::IdBeginFunc;
...
TIdTokenKind TGenLex::CharsetFunc()
{
	TIdTokenKind result = TIdTokenKind::IdBeginFunc;
...
TIdTokenKind TGenLex::IdentFunc()
{
	TIdTokenKind result = TIdTokenKind::IdBeginFunc;
...
void TGenLex::SpaceProc()
{
	while(CharInSet(FOrigin[Walker], GenLex__3))
		++Walker;
}

TIdTokenKind TGenLex::SpaceFunc()
{
	TIdTokenKind result = TIdTokenKind::IdBeginFunc;
...
void TGenLex::UnknownProc()
{
	++Walker;
}

TIdTokenKind TGenLex::UnknownFunc()
{
	TIdTokenKind result = TIdTokenKind::IdBeginFunc;
	result = TIdTokenKind::IdUnknown;
	return result;
