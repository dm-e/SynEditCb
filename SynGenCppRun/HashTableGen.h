...
public:
	...
	void __fastcall AssignKeyWords(System::Classes::TList* KeyList, bool CaseSensitive);
	...
	__fastcall TFrmHashTableGen(System::Classes::TComponent* AOwner);
};
...
private:
	int FMaxHashKey;
	bool FHashKeys[100000/*# range 0..MaxTableSize-1*/];
public:
